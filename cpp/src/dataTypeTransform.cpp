...
// Example std::transform call -> std::transform(dtVectorOut->begin(), dtVectorOut->end(), output->begin(), convertTypeFromNorm<DATA_TYPE, OUTPUT_TYPE>);
